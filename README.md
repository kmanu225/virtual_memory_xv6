...
```
cd existing_repo
git remote add origin https://gitlab-student.centralesupelec.fr/emmanuel.konan/tp_operating-system_memoire.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab-student.centralesupelec.fr/emmanuel.konan/tp_operating-system_memoire/-/settings/integrations)
